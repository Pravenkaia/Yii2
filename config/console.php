...
$config = [
    ...
    'container' => [
        'singletons' => [
            ...
            'notification' => ['class' => 'app\components\interfaces\NotificationInterface'], //alias короткое обращение
            //установим зависимости
            // указываем, какой класс реализует интерфейс
            // и задаем конфиг классу с настройками
